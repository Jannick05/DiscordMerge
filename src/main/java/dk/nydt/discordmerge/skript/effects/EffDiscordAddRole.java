...
public class EffDiscordAddRole extends Effect {
    ...
    static {
        Skript.registerEffect(EffDiscordAddRole.class, "[DiscordMerge ]add role with id %string% to %player%");
    }
    ...
    protected void execute(@NotNull Event event) {
        ...
        try {
            ...
            if(!member.getRoles().contains(role)) {
                ...
                System.out.println("Member already has role");
            }
    ...
    public @NotNull String toString(@Nullable Event e, boolean debug) {
        return "[DiscordMerge ]add role with id %string% to %player%";
    }
